...
### 1. CloudFormation template
 - EasyVPN Server Setup
    ...
    - Server Template: 
      ...
      - AWS Global Seoul: [Click-to-Launch](https://console.aws.amazon.com/cloudformation/home?region=ap-northeast-1#/stacks/new?stackName=EasyVPNServer&amp;templateURL=https://s3-ap-southeast-2.amazonaws.com/leopublic/templates/EasyVPN/EasyVPN_Server.template) 
